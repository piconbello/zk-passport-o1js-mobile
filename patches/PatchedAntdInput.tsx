// Patch Antd Input to not dismiss keyboard on simulator.
...
import { FormItemInputContext } from '@ant-design/react-native/lib/form/context';
import Icon from '@ant-design/react-native/lib/icon';
import DisabledContext from '@ant-design/react-native/lib/provider/DisabledContext'
import { ThemeContext, useTheme } from '@ant-design/react-native/lib/style'
import AntmView from '@ant-design/react-native/lib/view'
import { ClearIconType, InputProps, InputStatus } from '@ant-design/react-native/lib/input/PropsType'
import InputStyles from '@ant-design/react-native/lib/input/style'
...
const InternalInput: React.ForwardRefRenderFunction<TextInput, InputProps> = (
  ...
  React.useEffect(() => {
    const keyboardHide = Keyboard.addListener('keyboardDidHide', () => {
      if (isDevice) { // MY PATCH IS ONLY THIS LINE.
        Keyboard.dismiss()
      }
    })
    return () => {
